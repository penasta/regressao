...
ggplot(dados) +
  ...
  theme_bw() +
   ...
   ggtitle("Figura 1: Gráfico boxplot do preço de venda da casa (em dólares)")
```
...
kable(tabela_resumo, caption = "Quadro 1: Medidas Resumo do preço de venda da casa (em dólares)") %>%
